    ...
    return { 
        ...
        visitor : { 
            Program(nodePath , { opts ,file}) {
                ...
                if(
                    !ezitoTypes.function(resultPrepareInsertFunction) &&
                    !ezitoTypes.array(resultPrepareInsertFunction,ezitoTypes.oneOfType(ezitoTypes.string,ezitoTypes.function)) &&
                    !ezitoTypes.string(resultPrepareInsertFunction)
                ) return;
